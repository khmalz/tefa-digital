            ...
            <div class="container">
                <div class="justify-content-center d-flex flex-column gap-3">
                    <div class="row" style="row-gap: 18px">
                        <div class="notif-box d-flex col-12 rounded-lg shadow" data-aos="zoom-in-left" data-aos-delay="100">
                            <div class="box">
                                <div class="row">
                                    <div class="col-md-1 col-2 bg-warning d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-md-11 col-10 d-md-flex justify-content-between">
                                        <div class="pt-md-1 pt-2">
                                            ...
                                            <p style="font-size: 0.8rem">11:50:52 | 16 Nov 2023</p>
                                        </div>
                                        <div
                                            class="d-md-flex flex-column justify-content-center align-items-end mb-md-0 mb-1">
                                            <a href="#" style="font-size: 0.9rem">Mark as read</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="notif-box d-flex col-12 rounded-lg shadow" data-aos="zoom-in-left" data-aos-delay="100">
                            <div class="box">
                                <div class="row">
                                    <div class="col-md-1 col-2 bg-info d-flex justify-content-center align-items-center">
                        ...
                        <div class="notif-box d-flex col-12 rounded-lg shadow" data-aos="zoom-in-left" data-aos-delay="100">
                            <div class="box">
                                <div class="row">
                                    <div class="col-md-1 col-2 bg-success d-flex justify-content-center align-items-center">
