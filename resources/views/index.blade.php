            ...
            <div class="container">
                ...
                <div class="tab-content" data-aos="fade-up">
                    <div class="tab-pane active show" id="tab-1">
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                                ...
                                <p class="fst-italic">
                                    Dalam setiap pertemuan atau acara pasti terdapat moment - moment yang hadir tanpa di duga. 
                                    Untuk mengabadikan moment - moment tersebut dalam sebuah bidikan, anda membutuhkan sebuah jasa fotografi. 
                                </p>
                                <p>
                                    Sebuah jasa fotografi yang memiliki keahlian profesional dalam mengoperasikan kamera, sehingga dapat 
                                    menghasilkan gambar - gambar yang indah dan memikat hati Anda. Untuk itu, kami hadir dengan jasa - jasa yang kami miliki, 
                                    salah satunya adalah jasa fotografi. 
                                </p>
                                <p>
                                ...
                                <p>
                                    Untuk mengoperasikan kamera pasti semua orang bisa melakukannya. Tetapi untuk menghasilkan jepretan gambar yang 
                                    indah dan pas dari segala sisi, semua orang belum tentu bisa melakukannya. Jadi jika Anda membutuhkan jasa fotografi kami,
                                    kami siap melayani Anda dengan sepenuh hati.
                                </p>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="assets/img/photo.jpg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab-2">
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                                <h3 style="margin-top: 100px">Mengubah Moment yang Hadir Menjadi Karya Seni Bergerak</h3>
                                <p>
                                    ...
                                    Kami hadir dengan jasa videografi yang memiliki pemahaman mendalam serta keahlian profesional 
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="assets/img/video.jpg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab-3">
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                                <h3 style="margin-top: 150px">Mengubah Konsep - Konsep yang Telah Anda Buat Menjadi Desain yang Memikat</h3>
                                <p>
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="assets/img/design.jpg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="tab-4">
                        <div class="row">
                            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                                <h3 style="margin-top: 150px">Mengubah Gagasan Anda menjadi Karya Nyata.</h3>
                                <p>
                                    ...
                                    kami membantu merek Anda tampil mencolok dan menghadirkan pesan yang kuat kepada audiens. 
                                    Jadikan kami mitra dalam mencetak keberhasilan Anda
                                </p>
                            </div>
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="assets/img/print.jpg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
