        ...
        <div id="heroCarousel" data-bs-interval="5000" class="carousel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="carousel-container">
                    ...
                    <p class="animate__animated fanimate__adeInUp">Jadikan ide Anda bentuk nyata dengan 3D printing yang mengagumkan.</p>
                ...
                <div class="row content" data-aos="fade-up">
                    <div class="col-lg-6">
                        <p style="margin-bottom: 20px">
                            Pada zaman modern ini, kecanggihan teknologi memudahkan kita untuk melihat sebuah objek nyata hasil dari suatu ide dan konsep. Dengan 3D Printing buat ide Anda menjadi sebuah objek nyata yang menakjubkan.
                        </p>
                        <p style="margin-bottom: 20px">
                            Buat prototipe design Anda menjadi objek fisik tiga dimensi yang detail dan presisi. Jadikan bisnis Anda lebih inovatif dan pekerjaan lebih efektif dan efisien menggunakan jasa Kami.
                        </p>
                        <p>
                    ...
                    <div class="col-lg-6 pt-lg-0 pt-4 image-about">
                        <img src="https://source.unsplash.com/random/900×700/?3d-printing"
                            alt="" style="width: 100%;">
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-5">
                                        <div class="card-desc rounded-3 p-2" data-aos="zoom-in-left" data-aos-delay="100">
                                            ...
                                            <hr class="my-3">
                                            <p>Anda dapat dengan cepat mewujudkan ide-ide kreatif dalam bentuk prototipe fisik yang dapat langsung dipegang dan dievaluasi.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-5">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="card-desc rounded-3 p-2" data-aos="zoom-in-left" data-aos-delay="100">
                                            <div class="m-3">
                                                ...
                                                <hr class="my-3">
                                                <p>Kami dapat mencetak prototipe dalam waktu singkat tanpa perlu biaya besar.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <div class="card-desc rounded-3 p-2" data-aos="zoom-in-left" data-aos-delay="100">
                                            <div class="m-3">
                                                ...
                                                <hr class="my-3">
                                                <p>Kami memungkinkan Anda untuk menyesuaikan kebutuhan anda yang inovatif dijadikan prototipe.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
