                ...
                <div class="col-md-10">
                    ...
                    <div class="form-group d-flex flex-column mt-3 w-full gap-3">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="titleInput" class="form-control" name="title_plan"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="descriptionInput" name="description_plan" rows="3">{{ $plan->description }}</textarea>
                        ...
                        <div class="form-group d-md-flex align-items-center gap-3" data-feature-id="{{ $feature->id }}">
                            ...
                            <div class="d-flex align-items-md-center flex-column mt-md-0 mt-3 gap-2">
                                ...
                                <div><button type="button" class="btn btn-primary edit-feature"
                                        data-feature-id="{{ $feature->id }}" onclick="editFeature(this)">Edit</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
