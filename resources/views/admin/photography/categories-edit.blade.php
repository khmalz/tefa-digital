...
@section('content')
    <div class="container" style="height: 100%">
        <form action="{{ route('photography-category.update', $photographyCategory->id) }}" method="POST"
            ...
            <div>
                ...
                <input class="form-control @error('title') is-invalid @enderror" id="category-title-input" type="text"
                    name="title" value="{{ old('title', $photographyCategory->title) }}">
                @error('title')
            ...
            <div class="mt-3">
                ...
                <textarea class="form-control @error('body') is-invalid @enderror" id="category-description-input" name="body"
                    cols="30" rows="10">{{ old('body', $photographyCategory->body) }}</textarea>
                @error('body')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mt-3">
                ...
                @if ($photographyCategory->image !== 'placeholder.jpg')
                    <img src="{{ asset('assets/img/' . $photographyCategory->image) }}"
