                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('title_plan') is-invalid @enderror"
                                    name="title_plan" id="titleInput" value="{{ old('title_plan', $plan->title) }}">
                                @error('title_plan')
                    ...
                    @foreach ($plan->features as $feature)
                        <div class="form-group d-md-flex align-items-center gap-3" data-feature-id="{{ $feature->id }}">
                            <div class="d-flex flex-column w-100 mt-3 flex-wrap gap-3">
                                <div class="row gap-3">
                                    <label for="textInp{{ $feature->id }}" class="col-sm-2 col-form-label">Text</label>
                                    <div class="col">
                                        <input type="text"
                                            class="form-control @error('edit.*.text') is-invalid @enderror"
                                            id="textInp{{ $feature->id }}" value="{{ $feature->text }}" readonly>
                                        @error('edit.*.text')
                                            is-invalid
                                        @enderror
                                    </div>
