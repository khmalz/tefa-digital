                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card bg-primary mb-4 text-white">
                        <div class="card-body d-flex justify-content-between align-items-start pb-0">
                            <div>
                                <div class="fs-4 fw-semibold">
                                    ...
                                    <span class="fs-6 fw-normal">(-12.4%
                                        <svg class="icon">
                                            <use
                                                xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg#cil-arrow-bottom') }}">
                                            </use>
                                        </svg>)</span>
                                </div>
                                <div>Users</div>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-transparent p-0 text-white" type="button"
                            ...
                            <div>
                                <div class="fs-4 fw-semibold">
                                    ...
                                    <span class="fs-6 fw-normal">(40.9%
                                        <svg class="icon">
                                            <use
                                                xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg#cil-arrow-top') }}">
                                            </use>
                                        </svg>)</span>
                                </div>
                                <div>Income</div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                            ...
                            <button class="btn btn-primary" type="button">
                                <svg class="icon">
                                    <use
                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg#cil-cloud-download') }}">
                                    </use>
                                </svg>
                            </button>
                        </div>
                    ...
                    <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl my-4 text-white">
                                <use
                                    xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f') }}">
                                </use>
                            </svg>
                            <div class="chart-wrapper position-absolute start-0 w-100 h-100 top-0">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card mb-4" style="--cui-card-cap-bg: #00aced">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl my-4 text-white">
                                <use
                                    xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-twitter') }}">
                                </use>
                            </svg>
                            <div class="chart-wrapper position-absolute start-0 w-100 h-100 top-0">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl my-4 text-white">
                                <use
                                    xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-linkedin') }}">
                                </use>
                            </svg>
                            <div class="chart-wrapper position-absolute start-0 w-100 h-100 top-0">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group mb-5">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg#cil-user-female') }}">
                                                </use>
                                            </svg>
                                            <div>Female</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-google') }}">
                                                </use>
                                            </svg>
                                    ...
                                    <thead class="table-light fw-semibold">
                                        <tr class="align-middle">
                                            <th class="text-center">
                                                <svg class="icon">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg#cil-people') }}">
                                                    </use>
                                                </svg>
                                            </th>
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg#cif-us') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg#cif-br') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg#cif-in') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg#cif-fr') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg#cif-es') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg#cif-pl') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex') }}">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
